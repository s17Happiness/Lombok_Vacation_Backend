...
<head>
    ...
    <link rel="stylesheet" href="/css/List_cottage.css">
...
<body>
    <div class="row">
        ...
        <h3><span class="title">Lombok Vacation Cottage List</span></h3>
        <h3><span class="head">Cottage List</span></h3>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>Cottage Bunga Sepatu</td>
                    <td>Cottage Bunga Sepatu Terletak di Daerah Lombok</td>
                    <td>3</td>
                </tr>
                <tr>
                    <td>2</td>
                    <td><img src=asset/picture2.jpg /></td>
                    <td>Cottage Bunga Mawar</td>
                    <td>Cottage Bunga Mawar Terletak di Daerah Gili Trawangan</td>
                    <td>4</td>
                </tr>
                <tr>
                    <td>3</td>
                    <td><img src=asset/picture3.jpg /></td>
                    <td>Cottage Bunga Anggrek</td>
                    <td>Cottage Bunga Mawar Terletak di Daerah Gili Labak</td>
                    <td>5</td>
                </tr>
            </tbody>
        </table>
