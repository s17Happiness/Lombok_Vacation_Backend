...
<head>
    ...
    <link rel="stylesheet" href="/css/List_villa.css">
...
<body>
    <div class="row">
        ...
        <h3><span class="title">Lombok Vacation Villa List</span></h3>
        <h3><span class="head">Villa List</span></h3>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#">Villa</a>
                        </li>
                        <li class="nav-item">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>Villa Bunga Sepatu</td>
                    <td>Villa Bunga Sepatu Terletak di Daerah Lombok</td>
                    <td>3</td>
                </tr>
                <tr>
                    <td>2</td>
                    <td><img src=asset/picture2.jpg /></td>
                    <td>Villa Bunga Mawar</td>
                    <td>Villa Bunga Mawar Terletak di Daerah Gili Trawangan</td>
                    <td>4</td>
                </tr>
                <tr>
                    <td>3</td>
                    <td><img src=asset/picture3.jpg /></td>
                    <td>Villa Bunga Anggrek</td>
                    <td>Villa Bunga Mawar Terletak di Daerah Gili Labak</td>
                    <td>5</td>
                </tr>
            </tbody>
        </table>
